...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['app.test'] = new \ApiMaps\ApiMapBundle\Service\GetApi11($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_CustomerConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.customer_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '192.168.123.22', 'port' => NULL, 'dbname' => 'test', 'user' => 'monty', 'password' => 'test1234', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        $a = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '192.168.123.22', 'port' => NULL, 'dbname' => 'test', 'user' => 'monty', 'password' => 'test1234', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_37641a3b0a761f4413f2bb47f0ce458618443a63f64be7d6102fee7e5fbcd1aa');
        return $instance;
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ae4cebf27709.62148434')), true);
