...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // login_login_logout
        if ($pathinfo === '/logout') {
            return array (  '_controller' => 'ApiMaps\\ApiMapBundle\\Controller\\DefaultController::logoutAction',  '_route' => 'login_login_logout',);
        }

        // table_population
        if ($pathinfo === '/population') {
            return array (  '_controller' => 'ApiMaps\\ApiMapBundle\\Controller\\DefaultController::populationAction',  '_route' => 'table_population',);
        }
