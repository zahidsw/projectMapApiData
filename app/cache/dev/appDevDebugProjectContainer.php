...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.get_controller' => 'getApp_GetControllerService',
            'app.test' => 'getApp_TestService',
            'app.test1' => 'getApp_Test1Service',
    ...
    /**
     * Gets the 'app.get_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ApiMaps\ApiMapBundle\Controller\GetApiController A ApiMaps\ApiMapBundle\Controller\GetApiController instance.
     */
    protected function getApp_GetControllerService()
    {
        return $this->services['app.get_controller'] = new \ApiMaps\ApiMapBundle\Controller\GetApiController($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.test' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ApiMaps\ApiMapBundle\ApiMapService\ApiMapService A ApiMaps\ApiMapBundle\ApiMapService\ApiMapService instance.
     */
    protected function getApp_TestService()
    {
        return $this->services['app.test'] = new \ApiMaps\ApiMapBundle\ApiMapService\ApiMapService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.test1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ApiMaps\ApiMapBundle\ApiMapBundle A ApiMaps\ApiMapBundle\ApiMapBundle instance.
     */
    protected function getApp_Test1Service()
    {
        return $this->services['app.test1'] = new \ApiMaps\ApiMapBundle\ApiMapBundle($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_CustomerConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.customer_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '192.168.123.22', 'port' => NULL, 'dbname' => 'realtime', 'user' => 'monty', 'password' => 'test1234', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\ApiMaps\\ApiMapBundle\\Resources\\config\\doctrine') => 'ApiMaps\\ApiMapBundle\\Entity'));
        ...
        $b->addDriver($a, 'ApiMaps\\ApiMapBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'ApiMapBundle' => 'ApiMaps\\ApiMapBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7655d2a61c592b3041ffcd90aa3e26fbf278132797fe4af427cd688c6b634768');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ApiMaps\\ApiMapBundle/Resources/views'), 'ApiMap');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56b47d81cc0353.28135743')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ApiMapBundle' => 'ApiMaps\\ApiMapBundle\\ApiMapBundle',
